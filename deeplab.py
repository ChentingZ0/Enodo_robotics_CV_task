...
class DeeplabV3(object):
    _defaults = {
        ...
        #-------------------------------------------------------------------#
        # "model_path"        : 'logs/best_epoch_weights_v6_mobilenet.pth',
        "model_path"        : 'logs/best_epoch_weights_XCeptionNet_cropped_140.pth',
    ...
    def detect_image(self, image, count=True, name_classes=None):
        ...
        if self.mix_type == 0:
            ...
            #   将新图与原图及进行混合
            #------------------------------------------------#
            image_blend   = Image.blend(old_img, image, 0.7)
