...
if __name__ == "__main__":
    ...
    # model_path      = "model_data/swin_s3_base_224_backbone.pth"
    #---------------------------------------------------------#
    ...
    # Iron_path = 'SCRAPDATA'
    # Iron_path = 'SCRAP_V6'
    Iron_path = 'Cropped_v6'
    # 967 training, 241 val, 54 test
    # 6465 training images, 1509 validation images
    ...
    # {0: 1095810472, 1: 20319184, 2: 17228876, 3: 17095228}
    pixel_class = np.array([1013531114, 56000253, 23035342, 32859167])
    ...
    #   下载预训练权重
    #----------------------------------------------------#
    if backbone != "swintransformer_base" and backbone != "swintransformerv2":
        if pretrained:
            if distributed:
                if local_rank == 0:
