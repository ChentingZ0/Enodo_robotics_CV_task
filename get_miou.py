...
if __name__ == "__main__":
    ...
    image_ids       = open(os.path.join(Iron_path, "Iron_material/ImageSets/Segmentation/test.txt"),'r').read().splitlines()
    gt_dir          = os.path.join(Iron_path, "Iron_material/SegmentationClass")
    miou_out_path   = "miou_out"
    pred_dir        = os.path.join(Iron_path, 'Iron_material/prediction-results')
